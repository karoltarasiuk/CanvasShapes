    ...
    var Showcase = (function () {
        ...
        Showcase.prototype.toggleRelativeRendering = function () {
            ...
            $toggle.click(function () {
                that.elements.curve.setRelativeRendering(
                    !that.elements.curve.getRelativeRendering()
                );
                that.elements.curve.getSceneInterfaceHandlers()
                    .requestRendering(that.elements.curve);
