...
require([
    ...
    var Showcase = (function () {
        ...
        Showcase.prototype.createObjects = function () {
            ...
            this.elements.line = new CanvasShapes.Line([
                [10, 10], [90, 90]
            ]);
            this.elements.line.setRelativeRendering(true);
            this.elements.lineStyle = new CanvasShapes.Style({
                strokeStyle: 'darkBlue',
                fillStyle: 'lightBlue'
            });
            this.elements.lineStyle.addToShapes(this.elements.line);
        };
        ...
        Showcase.prototype.setupEvents = function () {
            ...
            this.elements.line.on('mouseover', function (e) {
                that.elements.lineStyle.setDefinition({
                    strokeStyle: 'darkRed',
                    fillStyle: '#FFCDCD'
                });
            ...
            this.elements.line.on('mouseout', function (e) {
                that.elements.lineStyle.setDefinition({
                    strokeStyle: 'darkBlue',
                    fillStyle: 'lightBlue'
                });
