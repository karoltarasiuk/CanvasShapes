...
define([
    ...
    describe('CanvasShapes.Shape', function () {
        ...
        describe('methods', function () {
            ...
            it('serialises to JSON properly', function () {

                var shape1 = new CanvasShapes.Shape(),
                    shape2 = new CanvasShapes.Shape([0, 0]),
                    shape3 = new CanvasShapes.Shape([[0, 0], [10, 10]]),
                    obj1 = {
                        metadata: {
                ...
                expect(shape1.toJSON()).toEqual(obj1);
                expect(shape2.toJSON()).toEqual(obj2);
                expect(shape3.toJSON()).toEqual(obj3);
            });

            it('deserialises from JSON properly', function () {
                ...
                expect(function () {
                    shape1 = CanvasShapes.Shape.prototype
                        .fromJSON.call(null, obj1);
                    shape2 = CanvasShapes.Shape.prototype
                        .fromJSON.call(null, obj2);
                    shape3 = CanvasShapes.Shape.prototype
                        .fromJSON.call(null, obj3);
                }).not.toThrow();

                expect(shape1.getUUID()).toBe(obj1.metadata.UUID);
                expect(shape1.getCoordinates()).toEqual(obj1.data.coordinates);

                expect(shape2.getUUID()).toBe(obj2.metadata.UUID);
                expect(shape2.getCoordinates()).toEqual(obj2.data.coordinates);

                expect(shape3.getUUID()).toBe(obj3.metadata.UUID);
                expect(shape3.getCoordinates()).toEqual(obj3.data.coordinates);

                expect(CanvasShapes.Class.getObject(obj1.metadata.UUID))
                    .toBe(shape1);
                expect(CanvasShapes.Class.getObject(obj2.metadata.UUID))
                    .toBe(shape2);
                expect(CanvasShapes.Class.getObject(obj3.metadata.UUID))
                    .toBe(shape3);
            });
        });
