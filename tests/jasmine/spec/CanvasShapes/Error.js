...
define([
    ...
    describe('CanvasShapes.Error', function () {
        ...
        it('getting message by code', function () {
            ...
            expect(error.getMessageByCode(1013)).toBe("CanvasShapes.Rectangle - passed coordinates are not creating 90 degrees angle");
        ...
        it('converting to string', function () {
            ...
            expect(temp.toString()).toBe('CanvasShapes.Error: 1013 - CanvasShapes.Rectangle - passed coordinates are not creating 90 degrees angle');
        });
