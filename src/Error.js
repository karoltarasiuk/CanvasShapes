...
CanvasShapes.Error = (function () {
    ...
    errors = {
        ...
        1011: "CanvasShapes.CoordinatesAbstract - in `validateCoordinates`: passed coordinates are not valid",
        ...
        1036: "CanvasShapes.Shape - in `initialise()`: wrong format of arguments passed",
        ...
        1061: "CanvasShapes.Scene - in `fromJSON()`: passed `obj` is not in valid format",
        1062: "CanvasShapes.Scene - in `fromJSON()`: wrong format of layer data",
        1063: "CanvasShapes.Point - in `fromJSON()`: passed `obj` is not in valid format",
        1064: "CanvasShapes.Class - in `fromJSON()`: passed arguments are not in valid format",
        1065: "CanvasShapes.Style - in `fromJSON()`: passed `obj` is not in valid format",
        1066: "CanvasShapes.Class - in `fromJSON()`: provided `obj.metadata.className` is not an object or object doesn\'t have `fromJSON()` method",
        1067: "CanvasShapes.RenderingAbstract - in `setStyle()`: passed arguments is not in valid format",
        1068: "CanvasShapes.Group - in `setStyle()`: passed arguments is not in valid format",
        1069: "CanvasShapes.CoordinatesAbstract - in `processCoordinates()`: passed coordinates contain objects instead of simple arrays or UUIDs",
        1070: "CanvasShapes.Shape - in `fromJSON()`: passed `className` doesn't relate to any object within CanvasShapes namespace",
        1071: "CanvasShapes.Renderer - in `fromJSON()`: passed `obj` is not in valid format",
        1072: "CanvasShapes.SceneAbstract - in `getLayerObjectByLayer()`: passed `layer` is not in valid format",
        1073: "CanvasShapes.SceneAbstract - in `requestRendering()`: passed `animationFrame` is not in valid format",
        ...
        9013: '',
        9014: 'CanvasShapes.CoordinatesInterface - `validateCoordinates()` is not implemented',
        ...
        9069: "CanvasShapes.CoordinatesInterface - `convertCoordinatesObjects()` is not implemented",
        9070: "CanvasShapes.CoordinatesInterface - `areCoordinatesSingle()` is not implemented",
    };
